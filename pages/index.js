                    ...
                    <div className="gap-10 py-10 lg:flex lg:flex-row lg:flex-wrap">
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://sabramson16.github.io/weather-dashboard">
                                <Image className="rounded-lg object-cover" src={weather} width={'100%'} height={'100%'} layout={'responsive'}></Image>
                            </a>
                        ...
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://sabramson16.github.io/code-quiz/">
                                <Image className="w-full h-auto" src={quiz} width={'100%'} height={'100%'} layout={'responsive'} ></Image>
                            </a>
                        ...
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://drive.google.com/file/d/14cqS4adv-N9hgT42FDJjQmoMoK1AFiwq/view">
                                <Image className="w-full h-auto" src={employee} width={'100%'} height={'100%'} layout={'responsive'} ></Image>
                            </a>
                        ...
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://sabramson16.github.io/password-generator/">
                                <Image className="w-full h-auto" src={password} width={'100%'} height={'100%'} layout={'responsive'}></Image>
                            </a>
                        ...
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://doodledrop-7357eeb23db1.herokuapp.com/">
                                <Image className="w-full h-auto" src={doodle} width={'100%'} height={'100%'} layout={'responsive'}></Image>
                            </a>
                        ...
                        <div className="my-3 bg-gray-200 relative shadow-lg p-10 rounded-xl basis-1/3 flex-1 dark:bg-gray-800">
                            ...
                            <a href="https://book-club-u6w0.onrender.com">
                                <Image className="w-full h-auto" src={booknook} width={'100%'} height={'100%'} layout={'responsive'}></Image>
                            </a>
